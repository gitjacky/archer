...
class workflow(models.Model):
    ...
    status = models.CharField(verbose_name='状态',max_length=50, choices=(('已正常结束','已正常结束'),('人工终止流程','人工终止流程'),('自动审核中','自动审核中'),('等待DBA审核','等待DBA审核'),('执行中','执行中'),('自动审核不通过','自审核不通过'),('执行有异常','执行有异常')))

...
最后看起来像这样：<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/pymysql.png)<br/>
...
3. 自助审核SQL，提交SQL工单：<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/submitsql.png)<br/>
4. 版本发布提交SQL文件,查看版本工单列表，查看版本工单个详情：<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/versioncommit.png)<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/versionlist.png)<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/versiondetail.png)<br/>
5. mongo编码同步工单提交，批量提交，同步工单列表：<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/mongocommit.png)<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/groupsync.png)<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/mongolist.png)<br/>
6. 用户、集群、工单管理：<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/adminsqlusers.png)<br/>
7. 开发工单DDL统计图表，工单个数统计图表：<br/>
![image](https://github.com/gitjacky/archer/raw/master/screenshots/ddlcount.png)<br/>
